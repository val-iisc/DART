...
class Evaluator:
    ...
    def evaluate(self, algorithm, suffix):
        ...
        # for key order
        summaries["test_in"+suffix] = 0.0
        summaries["test_out"+suffix] = 0.0
        summaries["comb_val"+suffix] = 0.0
        ...
        for name, loader_kwargs, weights in self.eval_meta:
            ...
            if skip_eval:
                continue  ## removing env_in of train envs
            ...
            if env_num in self.train_envs:
                summaries["comb_val" + suffix] += acc / n_train_envs
                if inout == "out":
                    summaries["comb_val_loss"+suffix] += loss / n_train_envs
            elif is_test:
                summaries["test_" + inout + suffix] += acc / n_test_envs
